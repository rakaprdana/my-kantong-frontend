    ...
    <section className="fixed inset-0 z-50 flex justify-center items-center bg-black/50 backdrop-blur-sm">
      <div className="relative bg-white shadow-lg p-6 w-[400px] flex flex-col items-center gap-6">
        ...
        <div className="flex gap-4 w-full">
          <Button className="flex-1 bg-green-500 hover:bg-green-600 text-white font-medium py-3 transition">
            Income
          </Button>

          <Button className="flex-1 bg-red-500 hover:bg-red-600 text-white font-medium py-3 transition">
            Outcome
          </Button>
        </div>
      </div>
